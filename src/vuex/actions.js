        ...
        [
            {
                ...
                intro: 'iPhone7 / 6s / 8 phim cường lực Apple 7Plus toàn màn hình phủ sóng 3D chống xanh',
                price: 29.00
            },
            {
                img: 'static/img/otherBuy/2.jpg',
                intro: 'Cáp dữ liệu Apple Cáp sạc Apple iPhoneX / 6s / 7plus / 8',
                price: 36.00
            },
            {
                img: 'static/img/otherBuy/3.jpg',
                intro: 'Apple 8/7/6/6 s phim cường lực iphone8 / 7 / 6s / 6 kính cường lực',
                price: 19.00
            },
            {
                img: 'static/img/otherBuy/4.jpg',
                intro: 'iPhone6s/7/8 Plus Điện thoại di động phim chống ánh sáng màu xanh màn hình không đầy đủ',
                price: 28.00
            }
        ],[
            {
                img: 'static/img/otherBuy/5.jpg',
                intro: 'Vỏ điện thoại Apple 6s iPhone6s Plus, Vỏ bảo vệ',
                price: 28.00
            },
            {
                img: 'static/img/otherBuy/6.jpg',
                intro: 'iPhone7/8 Điện thoại di động trường hợp điện thoại di động trường hợp chống rơi matte vỏ bảo vệ bầu trời đầy sao đen ☆ bao gồm tất cả bảo vệ',
                price: 30.00
            },
            {
                img: 'static/img/otherBuy/7.jpg',
                intro: 'Cáp dữ liệu cho iPhone 6s/6plus/7plus/8/X',
                price: 18.00
            },
            {
                img: 'static/img/otherBuy/8.jpg',
                intro: 'iPhone8 /7/6S/6 phim cường lực Apple 8/7/6s/6 phim thủy tinh',
                price: 15.00
            }
        ]];
...
export const loadAddress = ({ commit }) => {
    return new Promise((resolve, reject) => {
        ...
        },
        {
            ...
            province: 'Thượng Hải',
            city: 'Thượng Hải',
            area: 'Khu Phố Mới Pudong',
            address: 'Thị trấn Shaxin',
            phone: '158****0888',
            postalcode: '200120'
        }];
...
export const loadShoppingCart = ({ commit }) => {
    return new Promise((resolve, reject) => {
        const data = [{
            ...
            count: 1,
            img: 'static/img/goodsDetail/pack/1.jpg',
            package: '4,7 inch - sâu chàm',
            price: 28,
            title: 'Vỏ bảo vệ vỏ máy tính xách tay của Apple 8/7 Vỏ bảo vệ iPhone7 Plus Bao gồm tất cả vỏ cứng chống trầy xước'
        }];
